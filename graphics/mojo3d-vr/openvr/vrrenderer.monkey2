...
Class VRControllerState
	...
	Method Update( index:Int,origin:ETrackingUniverseOrigin )
		...
		If Not VRSystem().GetControllerStateWithPose( origin,index,Varptr _state,stdlib.plugins.libc.sizeof( _state ),Varptr _pose )
...
Class VRRenderer Extends Renderer
	...
	Method Update()
		...
		While VRSystem().PollNextEvent( Varptr vrevent,stdlib.plugins.libc.sizeof( vrevent ) )
