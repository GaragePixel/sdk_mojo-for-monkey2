...
#If __TARGET__="macos"
	...
	#rem monkeydoc Called once after a Window has been created and OnCreateWindow() called.
	#end
	Method OnCreate() Virtual
		'Added by iDkP
		'Because OnCreateWindow of the window class is an idiom.
	End
	
	#rem monkeydoc Called once after a Window has been created.
	#end
	Method OnCreateWindow() Virtual 'deprecated
	End
	...
	Public 'Private 'Unprivated by IdKp
...
#Endif
	...
	Method Init( title:String,rect:Recti,flags:WindowFlags )
		...
		'If flags & WindowFlags.Floating sdlFlags|=SDL_WINDOW_FLOATING
