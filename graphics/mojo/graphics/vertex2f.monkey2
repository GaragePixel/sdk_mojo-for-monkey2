...
Struct Vertex2f
	...
	Field color2:UInt 'jl added
	Field xyzPosition:Vec3f 'jl added
	Field Normal:Vec3f 'jl added
...
Class Vertex2fFormat Extends VertexFormat
	...
	Method UpdateGLAttribs() Override
		...
		'iDkP: TODO see if these elements should be added-target-conditioned?
