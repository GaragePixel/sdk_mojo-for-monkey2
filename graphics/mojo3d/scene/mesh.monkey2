...
Class Mesh Extends Resource
	...
	Method SetVertices( vertices:Vertex3f Ptr,first:Int,count:Int )
		...
		stdlib.plugins.libc.memcpy( _vertices.Data.Data+first,vertices,count*Vertex3f.Pitch )
	...
	Method SetTriangles( indices:UInt Ptr,first:Int,count:Int,materialid:Int=0 )
		...
		stdlib.plugins.libc.memcpy( mindices.Data.Data+first,indices,count*IndexPitch )
	End
	...
	Method GetAllIndices:Uint[]()
		...
		For Local material:=Eachin _materials
			...
			stdlib.plugins.libc.memcpy( ip,mindices.Data.Data,mindices.Length*IndexPitch )
			ip+=mindices.Length
		Next
