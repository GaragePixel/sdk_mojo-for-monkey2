...
'		Print "eols1="+eols1+", eols2="+eols2+", dlines="+dlines+", dchars="+dchars+" text="+text.Length
		...
		stdlib.plugins.libc.memmove( p + min + text.Length, p + max , oldlen-max )
		stdlib.plugins.libc.memset( p + min , 0 , text.Length )
...
'		Print "Document width="+_lines.Top.maxWidth+", height="+_lines.Top.rect.Bottom
	...
	Function IsIdent:Bool( chr:Int ) 'sorry about having integrated that here
